...
vim.keymap.set('n', '<leader>f', ':Format<CR>', { desc = "[F]ormat document" })
...
vim.opt.tabstop = 4             -- Width of rendered TAB
vim.opt.cursorline = true
vim.opt.cursorcolumn = false
vim.opt.backspace = '2'
vim.opt.shiftwidth = 2 -- How many spaces will TAB add
...
require('lazy').setup({
  ...
  { "nvim-tree/nvim-tree.lua", opts = { view = { adaptive_size = true } } },
  -- Comments
  { 'numToStr/Comment.nvim',   opts = {} },
  { 'akinsho/toggleterm.nvim', opts = {} },
  { 'windwp/nvim-autopairs',   opts = {} },
  { 'windwp/nvim-ts-autotag',  opts = { autotag = { enable = true } } },
  -- Fuzzy Finder
  {
  ...
  --    NOTE: Auto imports `lua/custom/plugins/*.lua`
